import { MusicoFormData } from "@/types/MusicoFormData.js";
...
export function MUSICOS_POST(body: MusicoFormData) {
...
export function MUSICOS_PUT(body: MusicoFormData, id: string) {
